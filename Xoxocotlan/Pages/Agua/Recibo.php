<?php
	...
	$sql="SELECT anio FROM agua WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT cantidad FROM agua WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT pagado FROM agua WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT cambio FROM agua WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT fecha FROM agua WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
