...
// verificación en caso de que se elija la opción de eliminar
 if (isset($_POST['eliminar'])){
    ...
    $sql="SELECT * FROM usuarios WHERE nombre='$_REQUEST[usuario]' AND contrasena=MD5('$_REQUEST[clave]')";
    ...
    if ($consulta) {
      ...
      if ($valor>0){
        ...
        $sql="DELETE FROM usuarios WHERE nombre='$_REQUEST[usuario]' AND contrasena=MD5('$_REQUEST[clave]')";
        ...
        echo '<script> alert("ERROR: El usuario o contraseña son erroneas");</script>';
      }
    }else{
...
if (isset($_POST['modificar'])) {
    ...
    if ($consulta) {
      ...
      if ($valor>0){
        ...
        $sql="INSERT INTO ayuda (valor) VALUES ('$id')";
        // Se ejecuta el comando
        $consulta=mysqli_query($conexion,$sql);
        // Se direcciona a una nueva página para las modificaciones 
        // Se pasa el valor del id
        header ("Location: modificarUsuario.php?var_pin=".($id));
      }else{
    ...
    <body>
        ...
        <div align="center">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                ...
                <label form="name">Nombre de usuario</label><br>
                <input type="text" name="usuario" class="input" required ><br><br><br>
                <label>Contraseña</label><br>
                <input type="password" name="clave" class="input" required><br><br><br>
