<?php
	...
	$sql="SELECT anio FROM tequios WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT cantidad FROM tequios WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT pagado FROM tequios WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT cambio FROM tequios WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT fecha FROM tequios WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
