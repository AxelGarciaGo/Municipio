<?php
	...
	$sql="SELECT anio FROM festividades WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$pdf->Ln();
	$pdf->SetTextColor(173,37,45,255);
	$pdf->Cell(0,10,'Festividad: ',0,0,'C',0);
	$sql="SELECT tipo FROM festividades WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	$festividad=mysqli_fetch_row($consulta);
	$pdf->Ln();
	$pdf->SetTextColor(0, 0, 0);
	$pdf->Cell(0,10,''.$festividad[0],0,0,'C',0);
	$pdf->Ln();//
	$pdf->SetTextColor(173,37,45,255);
	$pdf->Cell(0,10,'Cantidad a pagar: ',0,0,'C',0);
	$sql="SELECT cantidad FROM festividades WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT pagado FROM festividades WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT cambio FROM festividades WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
	...
	$sql="SELECT fecha FROM festividades WHERE num_toma='$valor[0]' ORDER BY num_toma DESC LIMIT 1";
	$consulta=mysqli_query($conexion,$sql);
