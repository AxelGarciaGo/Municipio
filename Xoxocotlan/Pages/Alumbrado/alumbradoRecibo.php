        ...
        <div align="center">
            ...
            <section class="recibo">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                    ...
                    <?php
                        // Comando para pedir el último folio de ticket generado
                        $sql="SELECT cantidad FROM alumbrado WHERE num_toma='$num'
                    ...
                    <?php
                        // Comando para pedir el último folio de ticket generado
                        $sql="SELECT pagado FROM alumbrado WHERE num_toma='$num'
                        ORDER BY num_toma DESC
                        LIMIT 1";
                        // Ejecución de consulta
                        $consulta=mysqli_query($conexion,$sql);
                    ...
                    <?php
                        // Comando para pedir el último folio de ticket generado
                        $sql="SELECT cambio FROM alumbrado WHERE num_toma='$num'
                        ORDER BY num_toma DESC
                        LIMIT 1";
                        // Ejecución de consulta
                        $consulta=mysqli_query($conexion,$sql);
